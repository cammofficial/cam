    ...
    */
    export class DiagramView extends CanvasControl {
        ...
        */
        ...
        _behavior: any;
        currentBehavior: LinkNodesBehavior | ModifyBehavior | DoNothingBehavior | DrawLinksBehavior | DrawNodesBehavior | PanBehavior | SelectOnlyBehavior | MagnifyBehavior | MoveNodesBehavior | MoveLabelsBehavior;
        /**
...
declare module "@mindfusion/diagramming" {
    ...
    export { ItemEventArgs, LinkEventArgs, NodeEventArgs, CellEventArgs, ComponentEventArgs, SelectionEventArgs, SerializeTagEventArgs, DiagramEventArgs, InplaceEditEventArgs, HeaderEventArgs, HeaderResizeEventArgs, TreeItemEventArgs, SelectionChangedEventArgs } from "Diagramming/EventArgs";
