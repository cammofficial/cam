document.addEventListener("DOMContentLoaded", function ()
{
	...
	e.innerHTML =
	'<hr />' +
	'<h1>About Charting</h1>' +
	'<p>Charting is a multi-functional dashboard library that draws various types of charts. It is implemented in TypeScript/JavaScript and renders graphics objects using the HTML 5 Canvas element. For Canvas support and heavy-duty geometric and layout calculations done in JavaScript, Charting requires a latest-generation browser. By providing your software with ready to use capabilities for laying out, rendering and feeding data into dashboards, Charting saves you hundreds of hours coding and debugging.</p>' +
	'<h2>Features</h2>' +
	'<ul>' +
