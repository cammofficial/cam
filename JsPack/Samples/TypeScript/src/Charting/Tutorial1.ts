...
let builder = new Controls.LayoutBuilder(dashboard);

let tc = new Components.TextComponent();
tc.text = "TITLE TEXT";
...
let grid = new Components.GridPanel();
...
let barPlot = new Charting.Plot2D();
let radarPlot = new Charting.RadarPlot();
let polarPlot = new Charting.PolarPlot();
let plot3d1 = new Charting.Plot3D();
let plot3d2 = new Charting.Plot3D();
let plot3d3 = new Charting.Plot3D();
let plot4 = new Charting.Plot2D();

linePlot.xAxis = new Charting.Axis();
linePlot.xAxis.minValue = 0;
linePlot.xAxis.maxValue = 15;
linePlot.xAxis.interval = 3;
...
let data1 = new Charting.BarSeries(
	new Collections.List<number>([10, 15, 17, 16, 20, 15, 14, 13, 10, 17, 22, 25, 25, 25, 21, 21]),
	null, null, new Collections.List<string>(["nov\n2014", "dec\n2014", "jan\n2015", "feb\n2015", "mar\n2015", "apr\n2015", "may\n2015",
		"jun\n2015", "jul\n2015", "aug\n2015", "sep\n2015", "oct\n2015", "nov\n2015", "dec\n2015", "jan\n2016",
		"feb\n2016"]));
data1.title = "LP Vinyl";
let data2 = new Charting.BarSeries(
	new Collections.List<number>([13, 13, 14, 16, 23, 25, 20, 19, 16, 17, 15, 13, 13, 17, 18, 21]), null);
data2.title = "CD";
let data3 = new Charting.BarSeries(
	new Collections.List<number>([29, 28, 29, 31, 33, 35, 33, 27, 28, 28, 27, 29, 29, 31, 33, 29]), null);
data3.title = "MP3";

let lineRenderer = new Charting.LineRenderer(new Collections.ObservableCollection<Charting.Series>([data1, data2, data3]));
let barDataRenderer = new Charting.BarRenderer(new Collections.ObservableCollection<Charting.Series>([data1, data2, data3]));
let radarDataRenderer = new Charting.RadarRenderer(new Collections.ObservableCollection<Charting.Series>([data1, data2, data3]));
let pieDataRenderer = new Charting.PieRenderer(data1, 1);
let bar3DDataRenderer = new Charting.BarRenderer3D(new Collections.ObservableCollection<Charting.Series>([data1, data2, data3]));
let horizontalBar3DDataRenderer = new Charting.BarRenderer(new Collections.ObservableCollection<Charting.Series>([data1, data2, data3]));
let barStack3DRenderer = new Charting.BarStackRenderer3D(new Collections.ObservableCollection<Charting.Series>([data1, data2, data3]));
let barOverlay3DRenderer = new Charting.BarOverlayRenderer3D(new Collections.ObservableCollection<Charting.Series>([data1, data2, data3]));
...
bar3DDataRenderer.seriesStyle = new Charting.PerSeriesStyle(
	new Collections.List<Drawing.Brush>([
		...
		new Drawing.Brush(Drawing.Color.fromArgb(0.6, 240, 230, 140)),
		new Drawing.Brush(Drawing.Color.fromArgb(0.6, 255, 165, 0))]),
	null, new Collections.List<number>([1]));
...
radarDataRenderer.seriesStyle = new Charting.PerSeriesStyle(
	...
	new Collections.List<Drawing.Brush>([
		new Drawing.Brush(new Drawing.Color("PaleGreen")),
		new Drawing.Brush(new Drawing.Color("PaleTurquoise")),
		new Drawing.Brush(new Drawing.Color("PaleVioletRed"))]), new Collections.List<number>([5]));
...
let xAxisRenderer = new Charting.XAxisRenderer(plot4.xAxis);
...
let yAxisRenderer = new Charting.YAxisRenderer(plot4.yAxis);
...
let xar = new Charting.XAxisRenderer(linePlot.xAxis);
xar.labelsSource = linePlot;
xar.showCoordinates = false;
xar.labelFontSize = 9;
xar.labelRotationAngle = 15;

let panel1 = builder.createPlotWithBottomAndLeftAxes(linePlot, xar, new Charting.YAxisRenderer(linePlot.yAxis));
...
let panel2 = builder.createPlotWithBottomAndRightAxes(barPlot, xar, new Charting.YAxisRenderer(barPlot.yAxis));
...
let yar = new Charting.YAxisRenderer(plot3d1.yAxis);
yar.titleBrush = new Drawing.Brush(new Drawing.Color("Green"));
yar.titleFontName = "Verdana";
yar.titleFontSize = 10;

let panel3 = builder.createPlotWithTopAndRightAxes(plot3d1, xar, yar);
...
let panel4 = builder.createPlotWithTopAndLeftAxes(plot3d2, xar, yar);
...
let panel5 = builder.createPlotWithTopAndRightAxes(plot3d3, xar, yar);

let panel6 = builder.createPlotWithTopAndLeftAxes(plot4, xAxisRenderer, yAxisRenderer);
...
let miniGrid = new Components.GridPanel();
...
let legend = new Charting.LegendRenderer();
