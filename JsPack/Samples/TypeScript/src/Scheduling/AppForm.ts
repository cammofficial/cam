...
export class AppForm extends p.BaseForm {
    ...
    */
    drawContent() {
        ...
        var states = [{ value: 0, text: "confirmed" }, { value: 1, text: "pending" }, { value: 2, text: "cancelled" }];
        ...
        var item = this.item;
        control = this.createDropDownList({ id: "status", items: states, initValue: item.tag, addEmptyValue: false });
        control.element.style.width = "200px";
        this.addControl(control);
