...
namespace ThemedDialogs {
	...
	infoDialog.iconSrc = "../assets/icon_warning.png";
	infoDialog.render();
	infoDialog.left = infoDialog.top = Common.Unit.percentage(30);
