...
namespace CheckListBox {
    ...
    checkbox2.values = DomUtils.reverseMap(new Map(Object.entries(MyFlagEnum)));
    ...
    checkbox3.values = DomUtils.reverseMap(new Map(Object.entries(ui.TooltipPosition)));
    ...
    document.getElementById("multiple").onchange = function () {
        ...
        checkbox1.multiple = checkbox2.multiple = checkbox3.multiple = (<HTMLInputElement>document.getElementById("multiple")).checked;
    }

    document.getElementById("theme").onchange = function () {
        checkbox1.theme = checkbox2.theme = checkbox3.theme = (<HTMLSelectElement>document.getElementById("theme")).value;
    }
